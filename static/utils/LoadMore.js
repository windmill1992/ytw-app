        ...
        request.get(url, {
            success: function (res) {
                ...
                if (page[resultName]) {
                    ...
                    var preData = null;
                    if (resultListName != '') {
                        preData = page[resultName][resultListName] || page[resultName];
                    } else {
                        preData = page[resultName];
                    }
                    // console.log(preData,inList);
                    [].push.apply(preData, inList);//数组合并
                    param = page[resultName];
                } else {
                    param = res.data.result;
                } 
								page[resultName] = param;
